...
#print(len(sentences)) #thsi statement show length of sentences
#word = nltk.word_tokenize(paragraph)
#print(sentences)
#print(word)
stemmer = PorterStemmer()
#print(stopwords.words('english')) # this line show all stop waord in library of englishs

#Stemming
for i in range(len(sentences)):
    words = nltk.word_tokenize(sentences[i]) #Each sentences are getting through the loops and converting each sentences to word
